...
class ICTrainer(BaseTrainer):
    ...
    def step(
        self,
        queries: List[torch.LongTensor],
        queries_ref: List[torch.LongTensor],
        responses: List[torch.LongTensor],
        ...
        Args:
            ...
            responses (List[`torch.LongTensor`]):
                List of tensors containing the encoded responses of shape (`response_length`)
            context (List[`torch.FloatTensor`]):
                List of tensors containing the ic example for ref model.
        ...
        model_ref_inputs = self.prepare_model_inputs(queries_ref, responses)
